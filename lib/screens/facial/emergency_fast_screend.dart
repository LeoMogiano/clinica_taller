...
class CreateEFScreen extends StatelessWidget {
  const CreateEFScreen({Key? key, required this.userId}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _BuildForm(emergencyService, userId),
                      ],
                    ),
                  ),
                ),
...
class _BuildForm extends StatefulWidget {
  const _BuildForm(this.emergencyService, this.userId);
  final int userId;
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (formKey.currentState!.validate() &&
                ...
                emergency.userId = widget.userId;
                print(emergency.userId);
                emergency.estado = 'En atención';
                emergency.diagnostico = '';
                emergency.nameUser = userService.pacientes
                    .firstWhere((element) => element.id == emergency.userId)
                    .name;
                emergency.id = await widget.emergencyService
                    .getEmergencies()
